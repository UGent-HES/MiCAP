...
*******************************************************************************************************
**/
#ifndef MICAP_H_ /* prevent circular inclusions */
#define MICAP_H_ /* by using protection macros */
...
int MiCAP_SetClbBits(long clb_row, long clb_col, const u8 Resource[][2], const u8 Value[], long NumBits);
